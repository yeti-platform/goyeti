...
`func (o *ResponsePatchApiV2ObservablesObservableIdPatch) SetContext(v []map[string]interface{})`
...
`func (o *ResponsePatchApiV2ObservablesObservableIdPatch) GetTags() map[string]TagRelationshipOutput`
