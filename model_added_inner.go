...
// AddedInner struct for AddedInner
type AddedInner struct {
	ASNOutput         *ASNOutput
	BICOutput         *BICOutput
...
func (dst *AddedInner) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(AddedInner)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src AddedInner) MarshalJSON() ([]byte, error) {
...
type NullableAddedInner struct {
	value *AddedInner
	isSet bool
}

func (v NullableAddedInner) Get() *AddedInner {
	return v.value
}

func (v *NullableAddedInner) Set(val *AddedInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAddedInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAddedInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddedInner(val *AddedInner) *NullableAddedInner {
	return &NullableAddedInner{value: val, isSet: true}
}

func (v NullableAddedInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddedInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
