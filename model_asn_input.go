...
// checks if the ASNInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ASNInput{}

// ASNInput struct for ASNInput
...
func (o *ASNInput) SetDescriptionNil() {
...
func (o ASNInput) MarshalJSON() ([]byte, error) {
...
func (o ASNInput) ToMap() (map[string]interface{}, error) {
...
func (o *ASNInput) UnmarshalJSON(data []byte) (err error) {
	...
	varASNInput := _ASNInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varASNInput)

	if err != nil {
		return err
	}

	*o = ASNInput(varASNInput)

	return err
}

type NullableASNInput struct {
	value *ASNInput
	isSet bool
}

func (v NullableASNInput) Get() *ASNInput {
	return v.value
}

func (v *NullableASNInput) Set(val *ASNInput) {
	v.value = val
	v.isSet = true
}

func (v NullableASNInput) IsSet() bool {
	return v.isSet
}

func (v *NullableASNInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableASNInput(val *ASNInput) *NullableASNInput {
	return &NullableASNInput{value: val, isSet: true}
}

func (v NullableASNInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableASNInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
