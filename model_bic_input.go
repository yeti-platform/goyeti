...
// checks if the BICInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BICInput{}

// BICInput struct for BICInput
...
func (o BICInput) MarshalJSON() ([]byte, error) {
...
func (o BICInput) ToMap() (map[string]interface{}, error) {
...
func (o *BICInput) UnmarshalJSON(data []byte) (err error) {
	...
	varBICInput := _BICInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBICInput)

	if err != nil {
		return err
	}

	*o = BICInput(varBICInput)

	return err
}

type NullableBICInput struct {
	value *BICInput
	isSet bool
}

func (v NullableBICInput) Get() *BICInput {
	return v.value
}

func (v *NullableBICInput) Set(val *BICInput) {
	v.value = val
	v.isSet = true
}

func (v NullableBICInput) IsSet() bool {
	return v.isSet
}

func (v *NullableBICInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBICInput(val *BICInput) *NullableBICInput {
	return &NullableBICInput{value: val, isSet: true}
}

func (v NullableBICInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBICInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
