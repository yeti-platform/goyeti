...
// checks if the BICOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BICOutput{}

// BICOutput struct for BICOutput
type BICOutput struct {
...
func (o BICOutput) MarshalJSON() ([]byte, error) {
...
func (o BICOutput) ToMap() (map[string]interface{}, error) {
...
func (o *BICOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varBICOutput := _BICOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBICOutput)

	if err != nil {
		return err
	}

	*o = BICOutput(varBICOutput)

	return err
}

type NullableBICOutput struct {
	value *BICOutput
	isSet bool
}

func (v NullableBICOutput) Get() *BICOutput {
	return v.value
}

func (v *NullableBICOutput) Set(val *BICOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableBICOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableBICOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBICOutput(val *BICOutput) *NullableBICOutput {
	return &NullableBICOutput{value: val, isSet: true}
}

func (v NullableBICOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBICOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
