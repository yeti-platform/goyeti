...
// checks if the CommandLineInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommandLineInput{}

// CommandLineInput struct for CommandLineInput
...
type _CommandLineInput CommandLineInput
...
func (o CommandLineInput) MarshalJSON() ([]byte, error) {
...
func (o CommandLineInput) ToMap() (map[string]interface{}, error) {
...
func (o *CommandLineInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCommandLineInput := _CommandLineInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommandLineInput)

	if err != nil {
		return err
	}

	*o = CommandLineInput(varCommandLineInput)

	return err
}

type NullableCommandLineInput struct {
	value *CommandLineInput
	isSet bool
}

func (v NullableCommandLineInput) Get() *CommandLineInput {
	return v.value
}

func (v *NullableCommandLineInput) Set(val *CommandLineInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCommandLineInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCommandLineInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommandLineInput(val *CommandLineInput) *NullableCommandLineInput {
	return &NullableCommandLineInput{value: val, isSet: true}
}

func (v NullableCommandLineInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommandLineInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
