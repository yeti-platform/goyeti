...
// checks if the CourseOfActionInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CourseOfActionInput{}

// CourseOfActionInput struct for CourseOfActionInput
type CourseOfActionInput struct {
...
type _CourseOfActionInput CourseOfActionInput
...
func (o CourseOfActionInput) MarshalJSON() ([]byte, error) {
...
func (o CourseOfActionInput) ToMap() (map[string]interface{}, error) {
...
func (o *CourseOfActionInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCourseOfActionInput := _CourseOfActionInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCourseOfActionInput)

	if err != nil {
		return err
	}

	*o = CourseOfActionInput(varCourseOfActionInput)

	return err
}

type NullableCourseOfActionInput struct {
	value *CourseOfActionInput
	isSet bool
}

func (v NullableCourseOfActionInput) Get() *CourseOfActionInput {
	return v.value
}

func (v *NullableCourseOfActionInput) Set(val *CourseOfActionInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCourseOfActionInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCourseOfActionInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCourseOfActionInput(val *CourseOfActionInput) *NullableCourseOfActionInput {
	return &NullableCourseOfActionInput{value: val, isSet: true}
}

func (v NullableCourseOfActionInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCourseOfActionInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
