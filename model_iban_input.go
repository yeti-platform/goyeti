...
// checks if the IBANInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IBANInput{}

// IBANInput struct for IBANInput
type IBANInput struct {
...
func (o IBANInput) MarshalJSON() ([]byte, error) {
...
func (o IBANInput) ToMap() (map[string]interface{}, error) {
...
func (o *IBANInput) UnmarshalJSON(data []byte) (err error) {
	...
	varIBANInput := _IBANInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIBANInput)

	if err != nil {
		return err
	}

	*o = IBANInput(varIBANInput)

	return err
}

type NullableIBANInput struct {
	value *IBANInput
	isSet bool
}

func (v NullableIBANInput) Get() *IBANInput {
	return v.value
}

func (v *NullableIBANInput) Set(val *IBANInput) {
	v.value = val
	v.isSet = true
}

func (v NullableIBANInput) IsSet() bool {
	return v.isSet
}

func (v *NullableIBANInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIBANInput(val *IBANInput) *NullableIBANInput {
	return &NullableIBANInput{value: val, isSet: true}
}

func (v NullableIBANInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIBANInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
