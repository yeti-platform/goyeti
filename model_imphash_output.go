...
// checks if the ImphashOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImphashOutput{}

// ImphashOutput struct for ImphashOutput
...
type _ImphashOutput ImphashOutput
...
func (o ImphashOutput) MarshalJSON() ([]byte, error) {
...
func (o ImphashOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ImphashOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varImphashOutput := _ImphashOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImphashOutput)

	if err != nil {
		return err
	}

	*o = ImphashOutput(varImphashOutput)

	return err
}

type NullableImphashOutput struct {
	value *ImphashOutput
	isSet bool
}

func (v NullableImphashOutput) Get() *ImphashOutput {
	return v.value
}

func (v *NullableImphashOutput) Set(val *ImphashOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableImphashOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableImphashOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImphashOutput(val *ImphashOutput) *NullableImphashOutput {
	return &NullableImphashOutput{value: val, isSet: true}
}

func (v NullableImphashOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImphashOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
