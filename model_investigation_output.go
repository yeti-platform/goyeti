...
// checks if the InvestigationOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvestigationOutput{}

// InvestigationOutput struct for InvestigationOutput
...
type _InvestigationOutput InvestigationOutput
...
func (o InvestigationOutput) MarshalJSON() ([]byte, error) {
...
func (o InvestigationOutput) ToMap() (map[string]interface{}, error) {
...
func (o *InvestigationOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varInvestigationOutput := _InvestigationOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvestigationOutput)

	if err != nil {
		return err
	}

	*o = InvestigationOutput(varInvestigationOutput)

	return err
}

type NullableInvestigationOutput struct {
	value *InvestigationOutput
	isSet bool
}

func (v NullableInvestigationOutput) Get() *InvestigationOutput {
	return v.value
}

func (v *NullableInvestigationOutput) Set(val *InvestigationOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableInvestigationOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableInvestigationOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvestigationOutput(val *InvestigationOutput) *NullableInvestigationOutput {
	return &NullableInvestigationOutput{value: val, isSet: true}
}

func (v NullableInvestigationOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvestigationOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
