...
// checks if the JA3Output type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JA3Output{}

// JA3Output struct for JA3Output
type JA3Output struct {
...
func (o JA3Output) MarshalJSON() ([]byte, error) {
...
func (o JA3Output) ToMap() (map[string]interface{}, error) {
...
func (o *JA3Output) UnmarshalJSON(data []byte) (err error) {
	...
	varJA3Output := _JA3Output{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varJA3Output)

	if err != nil {
		return err
	}

	*o = JA3Output(varJA3Output)

	return err
}

type NullableJA3Output struct {
	value *JA3Output
	isSet bool
}

func (v NullableJA3Output) Get() *JA3Output {
	return v.value
}

func (v *NullableJA3Output) Set(val *JA3Output) {
	v.value = val
	v.isSet = true
}

func (v NullableJA3Output) IsSet() bool {
	return v.isSet
}

func (v *NullableJA3Output) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJA3Output(val *JA3Output) *NullableJA3Output {
	return &NullableJA3Output{value: val, isSet: true}
}

func (v NullableJA3Output) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJA3Output) UnmarshalJSON(src []byte) error {
	v.isSet = true
