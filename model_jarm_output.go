...
// checks if the JARMOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JARMOutput{}

// JARMOutput struct for JARMOutput
...
func (o JARMOutput) MarshalJSON() ([]byte, error) {
...
func (o JARMOutput) ToMap() (map[string]interface{}, error) {
...
func (o *JARMOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varJARMOutput := _JARMOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varJARMOutput)

	if err != nil {
		return err
	}

	*o = JARMOutput(varJARMOutput)

	return err
}

type NullableJARMOutput struct {
	value *JARMOutput
	isSet bool
}

func (v NullableJARMOutput) Get() *JARMOutput {
	return v.value
}

func (v *NullableJARMOutput) Set(val *JARMOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableJARMOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableJARMOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJARMOutput(val *JARMOutput) *NullableJARMOutput {
	return &NullableJARMOutput{value: val, isSet: true}
}

func (v NullableJARMOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJARMOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
