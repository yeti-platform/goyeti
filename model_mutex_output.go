...
// checks if the MutexOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MutexOutput{}

// MutexOutput struct for MutexOutput
...
func (o MutexOutput) MarshalJSON() ([]byte, error) {
...
func (o MutexOutput) ToMap() (map[string]interface{}, error) {
...
func (o *MutexOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varMutexOutput := _MutexOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMutexOutput)

	if err != nil {
		return err
	}

	*o = MutexOutput(varMutexOutput)

	return err
}

type NullableMutexOutput struct {
	value *MutexOutput
	isSet bool
}

func (v NullableMutexOutput) Get() *MutexOutput {
	return v.value
}

func (v *NullableMutexOutput) Set(val *MutexOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableMutexOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableMutexOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMutexOutput(val *MutexOutput) *NullableMutexOutput {
	return &NullableMutexOutput{value: val, isSet: true}
}

func (v NullableMutexOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMutexOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
