...
// checks if the NoteOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NoteOutput{}

// NoteOutput struct for NoteOutput
...
func (o NoteOutput) MarshalJSON() ([]byte, error) {
...
func (o NoteOutput) ToMap() (map[string]interface{}, error) {
...
func (o *NoteOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varNoteOutput := _NoteOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNoteOutput)

	if err != nil {
		return err
	}

	*o = NoteOutput(varNoteOutput)

	return err
}

type NullableNoteOutput struct {
	value *NoteOutput
	isSet bool
}

func (v NullableNoteOutput) Get() *NoteOutput {
	return v.value
}

func (v *NullableNoteOutput) Set(val *NoteOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableNoteOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableNoteOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNoteOutput(val *NoteOutput) *NullableNoteOutput {
	return &NullableNoteOutput{value: val, isSet: true}
}

func (v NullableNoteOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNoteOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
