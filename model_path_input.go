...
// checks if the PathInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PathInput{}

// PathInput struct for PathInput
...
func (o PathInput) MarshalJSON() ([]byte, error) {
...
func (o PathInput) ToMap() (map[string]interface{}, error) {
...
func (o *PathInput) UnmarshalJSON(data []byte) (err error) {
	...
	varPathInput := _PathInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPathInput)

	if err != nil {
		return err
	}

	*o = PathInput(varPathInput)

	return err
}

type NullablePathInput struct {
	value *PathInput
	isSet bool
}

func (v NullablePathInput) Get() *PathInput {
	return v.value
}

func (v *NullablePathInput) Set(val *PathInput) {
	v.value = val
	v.isSet = true
}

func (v NullablePathInput) IsSet() bool {
	return v.isSet
}

func (v *NullablePathInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePathInput(val *PathInput) *NullablePathInput {
	return &NullablePathInput{value: val, isSet: true}
}

func (v NullablePathInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePathInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
