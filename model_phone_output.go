...
// checks if the PhoneOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhoneOutput{}

// PhoneOutput struct for PhoneOutput
...
func (o PhoneOutput) MarshalJSON() ([]byte, error) {
...
func (o PhoneOutput) ToMap() (map[string]interface{}, error) {
...
func (o *PhoneOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varPhoneOutput := _PhoneOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPhoneOutput)

	if err != nil {
		return err
	}

	*o = PhoneOutput(varPhoneOutput)

	return err
}

type NullablePhoneOutput struct {
	value *PhoneOutput
	isSet bool
}

func (v NullablePhoneOutput) Get() *PhoneOutput {
	return v.value
}

func (v *NullablePhoneOutput) Set(val *PhoneOutput) {
	v.value = val
	v.isSet = true
}

func (v NullablePhoneOutput) IsSet() bool {
	return v.isSet
}

func (v *NullablePhoneOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhoneOutput(val *PhoneOutput) *NullablePhoneOutput {
	return &NullablePhoneOutput{value: val, isSet: true}
}

func (v NullablePhoneOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhoneOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
