...
// checks if the RegexInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegexInput{}

// RegexInput struct for RegexInput
...
func (o RegexInput) MarshalJSON() ([]byte, error) {
...
func (o RegexInput) ToMap() (map[string]interface{}, error) {
...
func (o *RegexInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRegexInput := _RegexInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegexInput)

	if err != nil {
		return err
	}

	*o = RegexInput(varRegexInput)

	return err
}

type NullableRegexInput struct {
	value *RegexInput
	isSet bool
}

func (v NullableRegexInput) Get() *RegexInput {
	return v.value
}

func (v *NullableRegexInput) Set(val *RegexInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRegexInput) IsSet() bool {
	return v.isSet
}

func (v *NullableRegexInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegexInput(val *RegexInput) *NullableRegexInput {
	return &NullableRegexInput{value: val, isSet: true}
}

func (v NullableRegexInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegexInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
