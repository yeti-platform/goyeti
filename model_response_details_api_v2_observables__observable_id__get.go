...
// ResponseDetailsApiV2ObservablesObservableIdGet struct for ResponseDetailsApiV2ObservablesObservableIdGet
type ResponseDetailsApiV2ObservablesObservableIdGet struct {
	ASNOutput         *ASNOutput
	BICOutput         *BICOutput
...
func (dst *ResponseDetailsApiV2ObservablesObservableIdGet) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ResponseDetailsApiV2ObservablesObservableIdGet)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ResponseDetailsApiV2ObservablesObservableIdGet) MarshalJSON() ([]byte, error) {
...
type NullableResponseDetailsApiV2ObservablesObservableIdGet struct {
	value *ResponseDetailsApiV2ObservablesObservableIdGet
	isSet bool
}

func (v NullableResponseDetailsApiV2ObservablesObservableIdGet) Get() *ResponseDetailsApiV2ObservablesObservableIdGet {
	return v.value
}

func (v *NullableResponseDetailsApiV2ObservablesObservableIdGet) Set(val *ResponseDetailsApiV2ObservablesObservableIdGet) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseDetailsApiV2ObservablesObservableIdGet) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseDetailsApiV2ObservablesObservableIdGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseDetailsApiV2ObservablesObservableIdGet(val *ResponseDetailsApiV2ObservablesObservableIdGet) *NullableResponseDetailsApiV2ObservablesObservableIdGet {
	return &NullableResponseDetailsApiV2ObservablesObservableIdGet{value: val, isSet: true}
}

func (v NullableResponseDetailsApiV2ObservablesObservableIdGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseDetailsApiV2ObservablesObservableIdGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
