...
// ResponseNewApiV2EntitiesPost struct for ResponseNewApiV2EntitiesPost
type ResponseNewApiV2EntitiesPost struct {
...
func (dst *ResponseNewApiV2EntitiesPost) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ResponseNewApiV2EntitiesPost)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ResponseNewApiV2EntitiesPost) MarshalJSON() ([]byte, error) {
...
type NullableResponseNewApiV2EntitiesPost struct {
	value *ResponseNewApiV2EntitiesPost
	isSet bool
}

func (v NullableResponseNewApiV2EntitiesPost) Get() *ResponseNewApiV2EntitiesPost {
	return v.value
}

func (v *NullableResponseNewApiV2EntitiesPost) Set(val *ResponseNewApiV2EntitiesPost) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseNewApiV2EntitiesPost) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseNewApiV2EntitiesPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseNewApiV2EntitiesPost(val *ResponseNewApiV2EntitiesPost) *NullableResponseNewApiV2EntitiesPost {
	return &NullableResponseNewApiV2EntitiesPost{value: val, isSet: true}
}

func (v NullableResponseNewApiV2EntitiesPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseNewApiV2EntitiesPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
