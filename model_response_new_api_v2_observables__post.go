...
// ResponseNewApiV2ObservablesPost struct for ResponseNewApiV2ObservablesPost
type ResponseNewApiV2ObservablesPost struct {
	ASNOutput         *ASNOutput
	BICOutput         *BICOutput
...
func (dst *ResponseNewApiV2ObservablesPost) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ResponseNewApiV2ObservablesPost)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ResponseNewApiV2ObservablesPost) MarshalJSON() ([]byte, error) {
...
type NullableResponseNewApiV2ObservablesPost struct {
	value *ResponseNewApiV2ObservablesPost
	isSet bool
}

func (v NullableResponseNewApiV2ObservablesPost) Get() *ResponseNewApiV2ObservablesPost {
	return v.value
}

func (v *NullableResponseNewApiV2ObservablesPost) Set(val *ResponseNewApiV2ObservablesPost) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseNewApiV2ObservablesPost) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseNewApiV2ObservablesPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseNewApiV2ObservablesPost(val *ResponseNewApiV2ObservablesPost) *NullableResponseNewApiV2ObservablesPost {
	return &NullableResponseNewApiV2ObservablesPost{value: val, isSet: true}
}

func (v NullableResponseNewApiV2ObservablesPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseNewApiV2ObservablesPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
