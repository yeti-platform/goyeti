...
// ResponseNewExtendedApiV2ObservablesExtendedPost struct for ResponseNewExtendedApiV2ObservablesExtendedPost
type ResponseNewExtendedApiV2ObservablesExtendedPost struct {
	ASNOutput         *ASNOutput
	BICOutput         *BICOutput
...
func (dst *ResponseNewExtendedApiV2ObservablesExtendedPost) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ResponseNewExtendedApiV2ObservablesExtendedPost)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ResponseNewExtendedApiV2ObservablesExtendedPost) MarshalJSON() ([]byte, error) {
...
type NullableResponseNewExtendedApiV2ObservablesExtendedPost struct {
	value *ResponseNewExtendedApiV2ObservablesExtendedPost
	isSet bool
}

func (v NullableResponseNewExtendedApiV2ObservablesExtendedPost) Get() *ResponseNewExtendedApiV2ObservablesExtendedPost {
	return v.value
}

func (v *NullableResponseNewExtendedApiV2ObservablesExtendedPost) Set(val *ResponseNewExtendedApiV2ObservablesExtendedPost) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseNewExtendedApiV2ObservablesExtendedPost) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseNewExtendedApiV2ObservablesExtendedPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseNewExtendedApiV2ObservablesExtendedPost(val *ResponseNewExtendedApiV2ObservablesExtendedPost) *NullableResponseNewExtendedApiV2ObservablesExtendedPost {
	return &NullableResponseNewExtendedApiV2ObservablesExtendedPost{value: val, isSet: true}
}

func (v NullableResponseNewExtendedApiV2ObservablesExtendedPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseNewExtendedApiV2ObservablesExtendedPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
