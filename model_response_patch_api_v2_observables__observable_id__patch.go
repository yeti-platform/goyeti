...
// ResponsePatchApiV2ObservablesObservableIdPatch struct for ResponsePatchApiV2ObservablesObservableIdPatch
type ResponsePatchApiV2ObservablesObservableIdPatch struct {
	ASNOutput         *ASNOutput
	BICOutput         *BICOutput
...
func (dst *ResponsePatchApiV2ObservablesObservableIdPatch) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ResponsePatchApiV2ObservablesObservableIdPatch)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ResponsePatchApiV2ObservablesObservableIdPatch) MarshalJSON() ([]byte, error) {
...
type NullableResponsePatchApiV2ObservablesObservableIdPatch struct {
	value *ResponsePatchApiV2ObservablesObservableIdPatch
	isSet bool
}

func (v NullableResponsePatchApiV2ObservablesObservableIdPatch) Get() *ResponsePatchApiV2ObservablesObservableIdPatch {
	return v.value
}

func (v *NullableResponsePatchApiV2ObservablesObservableIdPatch) Set(val *ResponsePatchApiV2ObservablesObservableIdPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableResponsePatchApiV2ObservablesObservableIdPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableResponsePatchApiV2ObservablesObservableIdPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponsePatchApiV2ObservablesObservableIdPatch(val *ResponsePatchApiV2ObservablesObservableIdPatch) *NullableResponsePatchApiV2ObservablesObservableIdPatch {
	return &NullableResponsePatchApiV2ObservablesObservableIdPatch{value: val, isSet: true}
}

func (v NullableResponsePatchApiV2ObservablesObservableIdPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponsePatchApiV2ObservablesObservableIdPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
