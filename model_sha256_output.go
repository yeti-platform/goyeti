...
// checks if the SHA256Output type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SHA256Output{}

// SHA256Output struct for SHA256Output
type SHA256Output struct {
...
type _SHA256Output SHA256Output
...
func (o SHA256Output) MarshalJSON() ([]byte, error) {
...
func (o SHA256Output) ToMap() (map[string]interface{}, error) {
...
func (o *SHA256Output) UnmarshalJSON(data []byte) (err error) {
	...
	varSHA256Output := _SHA256Output{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSHA256Output)

	if err != nil {
		return err
	}

	*o = SHA256Output(varSHA256Output)

	return err
}

type NullableSHA256Output struct {
	value *SHA256Output
	isSet bool
}

func (v NullableSHA256Output) Get() *SHA256Output {
	return v.value
}

func (v *NullableSHA256Output) Set(val *SHA256Output) {
	v.value = val
	v.isSet = true
}

func (v NullableSHA256Output) IsSet() bool {
	return v.isSet
}

func (v *NullableSHA256Output) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSHA256Output(val *SHA256Output) *NullableSHA256Output {
	return &NullableSHA256Output{value: val, isSet: true}
}

func (v NullableSHA256Output) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSHA256Output) UnmarshalJSON(src []byte) error {
	v.isSet = true
