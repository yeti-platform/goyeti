...
// checks if the SigmaInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SigmaInput{}

// SigmaInput Represents a Sigma rule.  Parsing and matching is yet TODO.
...
func (o SigmaInput) MarshalJSON() ([]byte, error) {
...
func (o SigmaInput) ToMap() (map[string]interface{}, error) {
...
func (o *SigmaInput) UnmarshalJSON(data []byte) (err error) {
	...
	varSigmaInput := _SigmaInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSigmaInput)

	if err != nil {
		return err
	}

	*o = SigmaInput(varSigmaInput)

	return err
}

type NullableSigmaInput struct {
	value *SigmaInput
	isSet bool
}

func (v NullableSigmaInput) Get() *SigmaInput {
	return v.value
}

func (v *NullableSigmaInput) Set(val *SigmaInput) {
	v.value = val
	v.isSet = true
}

func (v NullableSigmaInput) IsSet() bool {
	return v.isSet
}

func (v *NullableSigmaInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSigmaInput(val *SigmaInput) *NullableSigmaInput {
	return &NullableSigmaInput{value: val, isSet: true}
}

func (v NullableSigmaInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSigmaInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
