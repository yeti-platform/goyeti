...
// checks if the TLSHInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TLSHInput{}

// TLSHInput struct for TLSHInput
type TLSHInput struct {
...
func (o TLSHInput) MarshalJSON() ([]byte, error) {
...
func (o TLSHInput) ToMap() (map[string]interface{}, error) {
...
func (o *TLSHInput) UnmarshalJSON(data []byte) (err error) {
	...
	varTLSHInput := _TLSHInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTLSHInput)

	if err != nil {
		return err
	}

	*o = TLSHInput(varTLSHInput)

	return err
}

type NullableTLSHInput struct {
	value *TLSHInput
	isSet bool
}

func (v NullableTLSHInput) Get() *TLSHInput {
	return v.value
}

func (v *NullableTLSHInput) Set(val *TLSHInput) {
	v.value = val
	v.isSet = true
}

func (v NullableTLSHInput) IsSet() bool {
	return v.isSet
}

func (v *NullableTLSHInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTLSHInput(val *TLSHInput) *NullableTLSHInput {
	return &NullableTLSHInput{value: val, isSet: true}
}

func (v NullableTLSHInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTLSHInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
