...
// checks if the UrlInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UrlInput{}

// UrlInput struct for UrlInput
...
func (o UrlInput) MarshalJSON() ([]byte, error) {
...
func (o UrlInput) ToMap() (map[string]interface{}, error) {
...
func (o *UrlInput) UnmarshalJSON(data []byte) (err error) {
	...
	varUrlInput := _UrlInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUrlInput)

	if err != nil {
		return err
	}

	*o = UrlInput(varUrlInput)

	return err
}

type NullableUrlInput struct {
	value *UrlInput
	isSet bool
}

func (v NullableUrlInput) Get() *UrlInput {
	return v.value
}

func (v *NullableUrlInput) Set(val *UrlInput) {
	v.value = val
	v.isSet = true
}

func (v NullableUrlInput) IsSet() bool {
	return v.isSet
}

func (v *NullableUrlInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUrlInput(val *UrlInput) *NullableUrlInput {
	return &NullableUrlInput{value: val, isSet: true}
}

func (v NullableUrlInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUrlInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
